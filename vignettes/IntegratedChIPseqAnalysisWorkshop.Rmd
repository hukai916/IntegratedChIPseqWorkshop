...
## Example6: metagene analysis for a given feature/peak range {-#my-section}
...
## Example7: obtain enriched GO and pathways {-#my-section}
...
## Example8: determine if there is significant peak overlap among multiple sets {-#my-section}
